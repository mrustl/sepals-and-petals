...
When given a vector as the first argument both the keys will be equal to the values passed to the function.
...
The dataframe argument needs a specific format. There must be exactly two columns `key` and `value`. This type of passing the levels is most useful when one wants to programatically create a large number of levels.
